...
| [Object Detection Pipeline for YRIKKA](https://github.com/mashcodes10/yrikka-1A) (Sep 2025 - Dec 2025) | Improved object detection performace across the synthetic-to-real data gap using YOLO models through data cleaning, image annotation, and model fine-tuning. Evaluated detection accuracy across synthetic-only, real-only, and mixed training regimes. | Python, CVAT, YOLO, Computer Vision, Object Detection, Google Colab |    
